...
from isaaclab_assets.robots.ur5e_with_allegro import UR5e_AllEGRO_CFG  # isort: skip


@configclass
class UR5eAllegroLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        self.actions.gripper_action = mdp.EMAJointPositionToLimitsActionCfg(
            asset_name="robot",
            joint_names=["(index|middle|ring|thumb)_joint_[0-3]"],
            alpha=0.95,
...
@configclass
class UR5eAllegroLiftEnvCfg_PLAY(UR5eAllegroLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
